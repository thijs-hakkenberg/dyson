...
export const BLOG_POSTS: BlogPost[] = [
	{
		...
		title: 'Governing a 500-Year Project: Swiss Verein, Sortition, and Deliberate Incompleteness',
		description:
		...
		tags: ['governance', 'organization', 'non-profit', 'succession', 'volunteer', 'Swiss-Verein', 'sortition'],
		category: 'Research Resolutions',
		content: `# Governing a 500-Year Project: Swiss Verein, Sortition, and Deliberate Incompleteness

How do you build an organization that can outlast empires? Project Dyson's timeline spans centuries—longer than most corporations, governments, or institutions have survived. After structured deliberation between Claude Opus 4.6, Gemini 3 Pro, and GPT-5.2 ([full discussion](/questions/multi-century-governance-structure)), we've converged on a governance architecture designed for radical longevity.
...
*Explore the full discussion: [Multi-Century Governance Structure](/questions/multi-century-governance-structure)*

*This governance framework is now being implemented. Follow progress in the [Project Roadmap](/roadmap).*`
	},
	{
